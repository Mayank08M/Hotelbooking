            ...
            <div className={styles.body}>
                ...
                <div style={{ display: "flex", margin: "1rem 4rem", justifyContent: "space-between" }}>
                    ...
                    {coupon && (
                        ...
                        <div style={{ height: "100%", backgroundColor: "rgba(0,0,0, 0.347)", backdropFilter: "blur(5px)", width: "100%", position: "fixed", display: "flex", justifyContent: "center", top: "0", left: "0", alignItems: "center" }}>
                            <div style={{ background: "white", width:"40%", borderRadius:"15px", overflowY:"scroll", height:"80%" }}>
                                <div style={{ display: "flex", alignItems: "center", padding: "1rem 2rem", borderBottom: "1px solid grey", justifyContent:"center" }}>
                                    <div><RxCross2 onClick={handleClick} style={{fontSize:"2rem", cursor:"pointer"}}/></div>
                                    <div style={{ margin: "0 10rem", fontSize:"1.5rem", fontWeight:"bold", color:"#FF6C09" }}>All Hotel Rules</div>
                                </div>
                                <div style={{ margin: "1rem 3rem", borderBottom:"1px solid grey" }}>
                                    <div>
                                        <p style={{ fontSize: "25px", fontWeight: "bold", padding: "2rem 0 0 0" }}>Hotel Policies</p>
                                    </div>
                                    <div>
                                ...
                                <div style={{ margin: "0 3rem", borderBottom:"1px solid grey" }}>
                                    <div>
                                        <p style={{ fontSize: "25px", fontWeight: "bold", padding: "2rem 0 0 0" }}>Cancellation Policies</p>
                                    </div>
                                    <div>
                                        <div style={{ display: "flex", padding: "1rem 0 1rem 0" }}>
                                            <ul style={{ listStyle: "initial", color: "rgb(83, 83, 83)", fontSize: "18px" }}>
                                ...
                                <div style={{ margin: "0 3rem"}}>
                                    <div>
                                        <p style={{ fontSize: "25px", fontWeight: "bold", padding: "2rem 0 0 0" }}>Refund Policies</p>
                                    </div>
                                    <div>
                                        <div style={{ display: "flex", padding: "1rem 0 1rem 0" }}>
                                            <ul style={{ listStyle: "initial", color: "rgb(83, 83, 83)", fontSize: "18px" }}>
                                                <li>Refund can be done within 2 or 3 business days.</li>
                                            </ul>
